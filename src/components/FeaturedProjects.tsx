    ...
    return (
        <section id="projects" className="mb-10">
            ...
            <ProjectCard 
                ...
                technologies={["React", "TypeScript", "Tailwind CSS", "Open-Meteo API"]}
                ...
                learned="Building this project gave me practical experience working with external APIs, managing asynchronous data in React, and designing components that update dynamically as new data is received."
